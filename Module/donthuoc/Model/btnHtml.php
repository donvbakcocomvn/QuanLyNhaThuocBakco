...
class btnHtml
{
    ...
    public static function btnsoanthuoc($id)
    {
        ...
        ?>
        <a type="button" class="btn btn-default text-blue btn-outline-primary"
            href="/index.php?module=donthuoc&controller=index&action=soanthuoc&id=<?php echo $id; ?>">
            Soạn đơn
        </a>
        <?php
    }
    ...
    public static function btnhoanthanhsoandon($id)
    {
        ...
        ?>
        <a onclick="return confirm('Bạn đã giao thuốc cho bệnh nhân?')" class="btn btn-info no-print"
            href="/index.php?module=donthuoc&controller=index&action=giaothuoc&id=<?php echo $id; ?>">
            Giao thuốc
        </a>
        <?php
    }
    ...
    public static function btnchitiet($id)
    {
        ...
        ?>
        <a class="btn btn-default" <?php echo \Model\FormRender::ToolTip("Chi tiết đơn thuốc"); ?>
            href="/index.php?module=donthuoc&controller=index&action=viewdonthuoc&id=<?php echo $id; ?>">
    ...
    public static function btnThemDonThuoc()
    {
        ...
        ?>
        <a class="btn btn-info" <?php echo \Model\FormRender::ToolTip("Thêm đơn thuốc mới"); ?>
            href="/index.php?module=donthuoc&controller=index&action=post&isnew=1">
    ...
    public static function btnSuaDonThuoc($id)
    {
        ...
        ?>
        <a class="btn btn-default no-print" <?php echo \Model\FormRender::ToolTip("Sửa đơn thuốc"); ?>
            href="/index.php?module=donthuoc&isnew=1&controller=index&action=put&id=<?php echo $id; ?>">
    ...
    public static function btnCopyDonThuoc($id)
    {
        ...
        ?>
        <a class="btn btn-primary" <?php echo \Model\FormRender::ToolTip("Sao chép đơn thuốc"); ?>
    ...
    public static function btnXoaDonThuoc($id)
    {
        ...
        ?>
        <a class="btn btn-danger" title="Bạn có muốn xóa danh mục này?"
            href="/index.php?module=donthuoc&controller=index&action=delete&id=<?php echo $id; ?>">
            Xóa
        </a>
        <?php
    }
