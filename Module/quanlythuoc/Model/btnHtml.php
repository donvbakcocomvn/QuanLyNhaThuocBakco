...
class btnHtml
{
    ...
    static function btnImportSanPham()
    {
        ...
        ?>
        <a class="btn btn-warning" <?php echo FormRender::ToolTip("Import danh sách thuốc từ File Excel"); ?>
            href="/index.php?module=quanlythuoc&controller=sanpham&action=import">
    ...
    static function btnExportSanPham()
    {
        ...
        ?>
        <a class="btn btn-success" <?php echo FormRender::ToolTip("Export danh sách thuốc ra Excel"); ?>
            href="/index.php?module=quanlythuoc&controller=sanpham&action=export">
    ...
    static function btnThemSanPham()
    {
        ...
        ?>
        <a class="btn btn-info" <?php echo FormRender::ToolTip("Thêm thuốc mới vào kho"); ?>
            href="/index.php?module=quanlythuoc&controller=sanpham&action=post">
    ...
    public static function btnSuaSanPham($id)
    {
        ...
        ?>
        <a class="btn btn-default" <?php echo FormRender::ToolTip("Sửa thuốc"); ?>
            href="/index.php?module=quanlythuoc&controller=sanpham&action=put&id=<?php echo $id; ?>">
    ...
    public static function btnChiTietSanPham($id)
    {
        ...
        ?>
        <a class="btn btn-default" <?php echo FormRender::ToolTip("Xem chi tiết thuốc"); ?>
            href="/index.php?module=quanlythuoc&controller=sanpham&action=detail&id=<?php echo $id; ?>">
    ...
    public static function btnBaoCao($id)
    {
        ...
        ?>
        <a class="btn btn-default" <?php echo FormRender::ToolTip("Báo cáo thuốc"); ?>
            href="/quanlythuoc/baocao/thuoc/<?php echo $id; ?>/">
    ...
    public static function btnXoaSanPham($id)
    {
        ...
        ?>
        <a class="btn btn-default" <?php echo FormRender::ToolTip("Xóa thuốc"); ?> title="Bạn có muốn xóa danh mục này?"
            href="/index.php?module=quanlythuoc&controller=sanpham&action=isdelete&id=<?php echo $id; ?>">
    ...
    public static function btnThemDanhMuc()
    {
        ...
        ?>
        <a class="btn btn-info" <?php echo FormRender::ToolTip("Thêm danh mục thuốc mới "); ?>
            href="/index.php?module=quanlythuoc&controller=danhmuc&action=post">
            <i class="fa fa-plus"></i> Thêm mới</a>
        <?php
    }
    ...
    public static function btnSuaDanhMuc($id)
    {
        ...
        ?>
        <a class="btn btn-default" <?php echo FormRender::ToolTip("Sửa danh mục thuốc"); ?>
            href="/index.php?module=quanlythuoc&controller=danhmuc&action=put&id=<?php echo $id; ?>">
    ...
    public static function btnXoaDanhMuc($id)
    {
        ...
        ?>
        <a class="btn btn-default" <?php echo FormRender::ToolTip("Xóa danh mục thuốc"); ?>
            title="Bạn có muốn xóa danh mục này?"
            href="/index.php?module=quanlythuoc&controller=danhmuc&action=delete&id=<?php echo $id; ?>">
            <i class="fa fa-trash-o text-red"></i>
        </a>
        <?php
    }
    ...
    public static function btnThemPhieuXuatNhap()
    {
        ...
        ?>
        <a class="btn btn-info" <?php echo FormRender::ToolTip("Thêm phiếu Xuất/Nhập mới"); ?>
            href="/index.php?module=quanlythuoc&controller=phieuxuatnhap&action=post&isnews=1">
    ...
    public static function btnSuaPhieuXuatNhap($id)
    {
        ...
        ?>
        <a class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="top" title="Sửa phiếu"
            href="/index.php?module=quanlythuoc&controller=phieuxuatnhap&action=put&id=<?php echo $id; ?>">
            Sửa
        </a>
        <?php
    }
    ...
    public static function btnXoaPhieuXuatNhap($id)
    {
        ...
        ?>
        <a class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Xóa phiếu"
            title="Bạn có muốn xóa phiếu này?"
            href="/index.php?module=quanlythuoc&controller=phieuxuatnhap&action=isdelete&id=<?php echo $id; ?>">
            Xóa
        </a>
        <?php
    }
    ...
    public static function btnChiTietPhieuXuatNhap($id)
    {
        ...
        ?>
        <a class="btn btn-default" <?php echo FormRender::ToolTip("Xem chi tiết phiếu"); ?>
            href="/quanlythuoc/phieuxuatnhap/detail/<?php echo $id; ?>">
            <i class="fa fa-eye text-yellow"></i>
        </a>
        <?php
    }
